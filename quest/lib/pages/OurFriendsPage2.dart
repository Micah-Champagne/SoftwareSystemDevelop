...
class OurFriendsPage2 extends StatefulWidget {
  final int index;

  const OurFriendsPage2({super.key, required this.index});

  @override
  State<OurFriendsPage2> createState() => _OurFriendsPage2State();
}

class _OurFriendsPage2State extends State<OurFriendsPage2> with TickerProviderStateMixin {
...
void initState() {
  ...
  buddies = BuddyListModel1.getCategories(); // Load all buddies once

  selectedUser = buddies[widget.index].name;
