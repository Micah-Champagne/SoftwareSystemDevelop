...
class OnboardingPg1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OnboardingScreen(
      ...
      description:
          'Turn your to-do list items into Quests, and complete them to earn points!',
      onNext: () {
...
class OnboardingPg2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OnboardingScreen(
      ...
      description:
          'Compete with friends, share tasks, and stay on track with social scoreboards.',
      onNext: () {
